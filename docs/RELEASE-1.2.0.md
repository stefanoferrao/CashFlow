# Notas de Atualização — v1.2.0

Faturas de todos os cartões somadas, rendimento real dos investimentos, conexão pelo Pluggy Connect sem erro e sem conexões repetidas, e um dashboard muito mais fácil de personalizar.
